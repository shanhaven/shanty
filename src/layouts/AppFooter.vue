...
<template>
  <div class="container">
    <div class="flex justify-between">
      ...
      <div class="flex space-x-6 justify-center align-middle">
        <a href="https://github.com/ShanCaj" class="text-gray-500 hover:text-gray-900 dark:hover:text-white content-center">
